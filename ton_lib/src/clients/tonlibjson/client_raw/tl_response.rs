use crate::clients::tonlibjson::client_raw::error::TvmStackError::TonLibError;
use crate::clients::tonlibjson::client_raw::stack::TLTvmCell;
use crate::clients::tonlibjson::client_raw::tl_types::{
...
pub enum TLResponse {
    // tonlib_api.client_raw, line 20
    Error {
        code: i32,
        message: String,
    },
    // tonlib_api.client_raw, line 21
    Ok(()),
    ...
    // tonlib_api.client_raw, line 167
    ...
    // tonlib_api.client_raw, line 203
    ...
    // tonlib_api.client_raw, line 243
