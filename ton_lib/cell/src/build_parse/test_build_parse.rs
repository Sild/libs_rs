use crate::build_parse::builder::TonCellBuilder;
use crate::build_parse::parser::TonCellParser;
// use crate::cell::cell_slice::CellSlice;

#[test]
fn test_build_parse_bit() -> anyhow::Result<()> {
    let mut writer = TonCellBuilder::new();
    ...
    let mut reader = TonCellParser::new(&cell);
